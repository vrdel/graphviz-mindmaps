...
- `target-make` finds a justfile or Makefile containing an outline target and runs it
...
For justfile projects generated by `create-mm`, `target-make mindmap-01.otl` runs `just -f justfile build mindmap-01.otl`.
