...
nodetype = {
    ...
    "todo": "shape=box fontcolor=\"%s\" margin=\"0.20\" style=\"filled, diagonals\" fillcolor=\"#FFF09A\" color=\"#B3A443\"" % (fontcolor["def"]),
    ...
    "ccyan": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#b9ffff\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "cblue": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#b2d5fb\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "cpink": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#ffb8fe\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "cred": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#fbc1bf\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "cyello": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#fefb88\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "corang": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#ffc990\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "cgrey": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#9e9e9e\" color=\"#8a8a8a\"" % (fontsize["l"]),
    "cblack": "shape=box style=\"rounded,radial\" fontsize=\"%s\" fillcolor=\"#2b2b2b\" color=\"#8a8a8a\"" % (fontsize["l"]),
}
